...
anchors = [  # 此处已经根据数据集特点更新了 anchor
    [(22, 29), (36, 42), (48, 49)],  # P3/8
    [(55, 68), (72, 59), (74, 82)],  # P4/16
    [(75, 104), (101, 106), (110, 165)]  # P5/32
]

class_name = ('nest', )  # 根据 class_with_id.txt 类别信息，设置 class_name
