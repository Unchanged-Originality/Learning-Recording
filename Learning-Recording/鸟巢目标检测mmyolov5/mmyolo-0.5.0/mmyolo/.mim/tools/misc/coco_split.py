...
#"D:/自己的文件/mmyolo-0.5.0/data/stonee/annotations/annotations_all.json"
#"D:\自己的文件\mmyolo-0.5.0\data\stone\Annotation\annotations_all.json"
def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument(
        '--json', type=str,  default='D:/自己的文件/mmyolo-0.5.0/data/stonee/annotations/annotations_all.json', help='COCO json label path')
    parser.add_argument(
        '--out-dir', type=str,default='D:/自己的文件/mmyolo-0.5.0/data/stonee/annotations',help='output path')
    parser.add_argument(
        '--ratios',
        default=[0.8, 0.2],
        nargs='+',
